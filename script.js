...
const modalPostBtn = document.querySelector('.modal-icons button');
...
btnTop.addEventListener('click', () => {
    ...
    const inpuPassword = document.querySelector('.password');

    if(inputUserInfo.value!== "" && inpuPassword.value !== "") {
        mainPage.style.display = 'none';
